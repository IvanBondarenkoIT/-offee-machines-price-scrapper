...
- **[PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md)** - Подробный обзор для директора
- **[FULL_CYCLE_GUIDE.md](FULL_CYCLE_GUIDE.md)** - Руководство по полному циклу
- **[EXECUTIVE_REPORT_GUIDE.md](EXECUTIVE_REPORT_GUIDE.md)** - Создание отчетов
- **[docs/](docs/)** - Техническая документация

### ☁️ Railway.com (Облачное размещение)
- **[QUICK_START_RAILWAY.md](QUICK_START_RAILWAY.md)** - Быстрый старт на Railway ⚡
- **[README_RAILWAY.md](README_RAILWAY.md)** - Полная документация Railway
- **[RAILWAY_DEPLOY.md](RAILWAY_DEPLOY.md)** - Пошаговая инструкция деплоя
- **[INVENTORY_UPLOAD_GUIDE.md](INVENTORY_UPLOAD_GUIDE.md)** - Загрузка остатков + дата актуальности
- **[RAILWAY_SUMMARY.md](RAILWAY_SUMMARY.md)** - Итоговый отчет
