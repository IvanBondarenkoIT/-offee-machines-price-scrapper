...
**⚡ Быстрый старт**: `python run_full_cycle.py` (2 минуты на всё!)

## 📚 Документация

- **[PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md)** - Подробный обзор для директора (рекомендуется начать с этого)
- **[FULL_CYCLE_GUIDE.md](FULL_CYCLE_GUIDE.md)** - Руководство по полному циклу
- **[EXECUTIVE_REPORT_GUIDE.md](EXECUTIVE_REPORT_GUIDE.md)** - Создание отчетов для руководства
