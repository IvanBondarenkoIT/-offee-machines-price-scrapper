...
TRANSLATIONS = {
    ...
    'ru': {
        ...
        'Model or name': 'Модель или название',
        'Search': 'Поиск',
        'Apply Filters': 'Применить фильтры',
        'Reset': 'Сбросить',
        'Expensive': 'Дороже',
        'No products available': 'Нет доступных товаров',
        'No uploads yet': 'Загрузок пока нет',
        'No Data Available': 'Нет данных',
        'Upload your first price comparison file to get started': 'Загрузите первый файл сравнения цен для начала',
    ...
    'ka': {
        ...
        'Brand': 'ბრენდი',
        'All Brands': 'ყველა ბრენდი',
        'Product Name': 'პროდუქტის სახელი',
        'Qty': 'რაოდ',
        'With Competitors': 'კონკურენტებთან',
        'Avg Price': 'საშუალო ფასი',
        'Model or name': 'მოდელი ან სახელი',
        'Search': 'ძებნა',
        'Apply Filters': 'ფილტრების გამოყენება',
        'Reset': 'განახლება',
        'Expensive': 'უფრო ძვირი',
